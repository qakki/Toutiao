package com.summer.blog.aspect;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.summer.blog.dao.*.*(..))")
    public void daoPc() {
    }

    @Pointcut("execution(* com.summer.blog.controller.*.*(..))")
    public void controllerPc() {
    }

    @Pointcut("execution(* com.summer.blog.service.*.*(..))")
